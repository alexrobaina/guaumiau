...
async function main() {
  ...
  // Service Provider 1 (Dog Walker & Sitter)
  ...
  // Service Provider 2 (Cat Specialist)
  ...
  // Service Provider 3 (Multi-service, both owner and provider)
  ...
  // Ana's availability (Monday to Friday, 9am-6pm)
  ...
  // Lucía's availability (All week, flexible hours)
  await prisma.availability.createMany({
    data: [
      'MONDAY',
      'TUESDAY',
  ...
  // ============================================================================
  // TRACKING (for completed booking)
  // ============================================================================
  ...
  const trackingPoints = [
    ...
    { lat: -34.59899, lng: -58.37691, event: 'pause', time: 20 }, // Water break
  ...
  await prisma.tracking.createMany({
    data: trackingPoints.map((point, index) => ({
      ...
      recordedAt: new Date(
        new Date('2024-10-15T10:00:00').getTime() + point.time * 60 * 1000,
      ),
    })),
  });
  ...
  await prisma.review.create({
    data: {
      ...
      comment:
        'Ana es increíble! Max llegó super feliz y cansado. Recibí fotos durante el paseo y se nota que lo trató con mucho amor. Súper recomendada!',
      photos: [],
      badgesAwarded: ['Super Walker', 'Great Communicator'],
      isPublic: true,
      response:
        'Muchas gracias María! Max es un amor, fue un placer pasearlo. Siempre bienvenidos!',
  ...
  await prisma.review.create({
    data: {
      ...
      trustworthinessRating: 5.0,
      comment:
        'María es una excelente dueña. Max está muy bien cuidado y educado. Comunicación perfecta!',
      isPublic: true,
    },
  });

  // Review for provider2 (in-progress booking, so older review)
  ...
  await prisma.review.create({
    data: {
      ...
      trustworthinessRating: 5.0,
      comment:
        'Lucía cuidó a mis gatos de manera excelente. Me mandó videos todos los días. Solo una pequeña demora en responder mensajes, pero todo perfecto!',
  ...
  await prisma.transaction.create({
    data: {
      ...
      amount: 800,
      currency: 'ARS',
      serviceFee: 680, // Provider receives 85%
      platformCommission: 120, // Platform takes 15%
      processingFee: 0,
  ...
  await prisma.message.createMany({
    data: [
      ...
      },
      {
        ...
        messageType: 'TEXT',
        content:
          'Hola María! Sí, confirmado para las 10am. Lo paso a buscar por tu casa?',
        isRead: true,
  ...
  await prisma.message.createMany({
    data: [
      ...
      },
      {
        ...
        messageType: 'TEXT',
        content:
          'Hola Carlos! Están super bien. Comieron todo el desayuno y jugaron un rato.',
        isRead: true,
  ...
  await prisma.notification.createMany({
    data: [
      ...
      },
      {
        ...
        message:
          'Tu reserva con Lucía comienza mañana a las 8am. No olvides preparar todo para tus gatos.',
  ...
  await prisma.userBadge.createMany({
    data: [
      {
        providerId: provider1Profile!.id,
        badgeId: badges[0].id, // Super Walker
      },
      {
        providerId: provider1Profile!.id,
        badgeId: badges[2].id, // Early Riser
      },
      {
        providerId: provider2Profile!.id,
        badgeId: badges[3].id, // Pet Whisperer
      },
      {
        providerId: provider3Profile!.id,
        badgeId: badges[0].id, // Super Walker
      ...
      {
        providerId: provider3Profile!.id,
        badgeId: badges[1].id, // Five Star Provider
      },
      {
        providerId: provider3Profile!.id,
        badgeId: badges[3].id, // Pet Whisperer
